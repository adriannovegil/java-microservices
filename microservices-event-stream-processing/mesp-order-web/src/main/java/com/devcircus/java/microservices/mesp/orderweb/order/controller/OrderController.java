...
public class OrderController {
    ...
    public OrderController(OrderService orderService, EventService<OrderEvent, Long> eventService, DiscoveryClient discoveryClient) {
    ...
    public ResponseEntity addReservation(@PathVariable Long id, @RequestParam(value = "reservationId") Long reservationId) {
