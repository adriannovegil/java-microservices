package com.devcircus.java.microservices.mesp.warehouseweb.warehouse.controller;

import com.devcircus.java.microservices.mesp.warehouseweb.inventory.domain.Inventory;
import com.devcircus.java.microservices.mesp.warehouseweb.inventory.domain.InventoryItems;
...
import com.devcircus.java.microservices.mesp.warehouseweb.warehouse.domain.WarehouseService;
...
public class WarehouseController {
    ...
    /**
     * Creates a new {@link Warehouse} entity and persists the result to the
     * repository.
     *
     * @param warehouse is the {@link Warehouse} model used to create a new
     * warehouse
     ...
     * @param warehouse is the entity representation containing any updated
     * {@link Warehouse} fields
    ...
    /**
     * Appends an {@link WarehouseEvent} domain event to the event log of the
     * {@link Warehouse} aggregate with the specified warehouseId.
     *
     * @param warehouseId is the unique identifier for the {@link Warehouse}
     * @param event is the {@link WarehouseEvent} that attempts to alter the
     * state of the {@link Warehouse}
     * @return a hypermedia resource for the newly appended
     * {@link WarehouseEvent}
     */
     ...
     * @return is a hypermedia enriched resource for the supplied
     * {@link Warehouse} entity
     */
