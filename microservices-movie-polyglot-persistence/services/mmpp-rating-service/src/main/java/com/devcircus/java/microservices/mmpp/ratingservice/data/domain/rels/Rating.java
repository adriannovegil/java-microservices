...
public class Rating {
    ...
    public boolean equals(Object o) {
        ...
        if (user != null ? !user.equals(rating1.user) : rating1.user != null) {
            return false;
        }
        if (product != null ? !product.equals(rating1.product) : rating1.product != null) {
            return false;
        }
        if (knownId != null ? !knownId.equals(rating1.knownId) : rating1.knownId != null) {
            return false;
        }
        if (timestamp != null ? !timestamp.equals(rating1.timestamp) : rating1.timestamp != null) {
            return false;
        }
