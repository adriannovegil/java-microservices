...
public class User implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (occupation != null ? !occupation.equals(user.occupation) : user.occupation != null) {
            return false;
        }
        if (zipcode != null ? !zipcode.equals(user.zipcode) : user.zipcode != null) {
            return false;
        }
        if (follows != null ? !follows.equals(user.follows) : user.follows != null) {
            return false;
        }
